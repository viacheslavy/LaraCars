...
class BlogSpider(scrapy.Spider):
	...
	def __init__(self,start_year=None,end_year=None,start_price=None,end_price=None,page_number=None,brand=None,model=None, *args, **kwargs):
		...
		url= 'https://www.hemmings.com/classifieds/cars-for-sale/?year_min='+start_year+'&year_max='+end_year+'&price_min='+start_price+'&price_max='+end_price+'&page_size='+str(page_size)+'&start='+str(start)+'&makeFacet='+str(brand)+'&modelFacet='+str(model)
		self.start_urls = [url]
