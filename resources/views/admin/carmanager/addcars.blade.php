...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
                                                        ...
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="checkbox pull-right">
                                                                <label>
                                                                    ...
                                                                    <?php
                                                                    $somePercentage = \App\Setting::find(1);
                                                                    ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group well">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <div class="checkbox pull-right">
                                                                    <label>
                                                                        <input type="checkbox" id="secondPCheckbox" name="enabled" class="flat onlyOneChecked" @if($percentage->enabled == 1) checked @endif> Enabled
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group well">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <div class="checkbox pull-right">
                                                                    <label>
                                                                        <input type="checkbox" id="thirdPCheckbox" name="enabled" class="flat onlyOneChecked" @if($globalRate->enabled == 1) checked @endif> Enabled
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <a class="btn btn-info" href="{{ route('get.newcar.cars') }}">Ajouter un nouveau listing</a>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal form-label-left" action="{{ route('post.add.new.listing') }}" id="addNewListingForm" method="POST">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Titre
                                    </label>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="clearfix"></div>
                            <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right top_search" style="margin-top: 30px;">
                        ...
                        <div class="x_content">
                            ...
                            @if ( !empty( $cars ) )
                                    ...
                                    <form action="{{ route('post.add.all.cars') }}" method="POST">
                                        ...
                                        @foreach($cars as $car)
                                            <input type="hidden" name="all_car_links[]" value="{{ $car->id }}">
                                        @endforeach
                                ...
                                <table id="carListings" class="display" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        @foreach($cars as $car)
                                            <tr>
                                                <th><input type="checkbox" class="checkMeAll" value="{{ $car->id }}" name="bulk_links[]"></th>
                                                <td>
                                                    @if($car->CarImg->count() != 0)
                                                        @foreach($car->CarImg as $image)
                                                            @if($image)
                                                                <img style="height: 50px; width: 70px" src="{{ $image->medium }}" alt="">
                                                                <?php break; ?>
                                                            @endif
                                                        @endforeach
                                                    @endif
                                                </td>
                                                <td>{{ $car->referenceID }}</td>
                                                <td>
                                                    @if($car->original_url && !empty($car->original_url))
                                                        {{ (strpos($car->original_url, strtolower('ebay'))) ? 'Ebay' : ((strpos($car->original_url, strtolower('carsforsale'))) ? 'Carsforsale' : ((strpos($car->original_url, strtolower('autotrader'))) ? 'Autotrader' : '' ))}}
                                                    @endif                                                    
                                                </td>
                                                <td>{{ $car->title }}</td>
                                                <td>{{ ($car->status == 'loaded') ? 'Loaded' : 'Not Loaded' }}</td>
                                                <td>{{ '$' . number_format($car->price) }}</td>
                                                <td>
                                                    <form id="thisIsViewForm" action="{{ route('get.car.details') }}" method="GET" target="_blank">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" value="{{ $car->original_url }}" name="car_link">
                                                        <button id="submitViewForm" class="btn btn-primary btn-xs" type="submit">VIEW</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            <form class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12">
                                        <br>
                                        <span style="width: 100%; display:block; margin: 0 auto; text-align:center">Loading...</span>
                                        <br>
                                        <div class="progress">
...
@section('scripts')
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(newOptions, function (index, value, key) {
                            $el.append($("<option></option>")
                                .attr("value", value.label).text(value.label));
                        });
                    }
                });
            ...
            $("#checkAllID").click(function(e) {
                ...
                myTable.rows().every( function ( rowIdx, tableLoop, rowLoop ) {
                    ...
                    if($("#checkAllID").is(":checked")) {
                        $tr.find(".checkMeAll").prop('checked', true);
                    } else {
                        $tr.find(".checkMeAll").prop('checked', false);
                    }
    ...
    <!-- <script src="http://localhost/laracars/public/js/dropzone.js"></script>
    <link rel="stylesheet" href="http://localhost/laracars/public/css/dropzone.css"> -->
