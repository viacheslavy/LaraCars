		...
		<div class="">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						{{ Form::model($pricerule, array('url' => 'cpanel/price/editprice/'.$pricerule->id, 'method' => 'post', 'class' => 'form-horizontal form-label-left', )) }}
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									{{Form::number('price', null, array( "required" => "", 'class' => 'form-control col-md-7 col-xs-12', 'id' => "reqPrice", 'min' => 0,))}}
								</div>
							</div>
							<div class="item form-group">
