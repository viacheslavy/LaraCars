        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {{ Form::model($modeldetails, ['route' => 'post.updatemodel.cars', 'class' => 'form-horizontal', 'files' => 'true', ]) }}
                            {{ csrf_field() }}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {{ Form::text('value', null, array('required' => '', 'class' => 'form-control', 'id' => 'name', 'placeholder' => "")) }}
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <a href="{{ route('get.model.cars') }}" class="btn btn-primary" type="reset">Cancel</a>
                                </div>
                            </div>
                       {{ Form::close() }}
                    </div>
