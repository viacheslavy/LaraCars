		...
		<div class="">
			<div class="page-title">
				...
				<div class="title_right">
					<div class="col-xs-12 col-sm-3 form-group pull-right"></div>
			...
			<form action="{{ route('post.gatewayclassiccars') }}" id="getCarsForm" method="GET">
				{{ csrf_field() }}
				<div class="row">
						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select id="proizvodjacSearch" class="form-control col-md- col-xs-12" name="make">
												...
												<option value="Acura" data-kw="Acura" data-lookup="Acura">Acura</option>
												<option value="Alfa Romeo" data-kw="Alfa Romeo" data-lookup="Alfa Romeo">Alfa Romeo</option>
												<option value="Ariel" data-kw="Ariel" data-lookup="Ariel">Ariel</option>
												<option value="Aston Martin" data-kw="Aston Martin" data-lookup="Aston Martin">Aston Martin</option>
												<option value="Audi" data-kw="Audi" data-lookup="Audi">Audi</option>
												<option value="Austin" data-kw="Austin" data-lookup="Austin">Austin</option>
												<option value="Austin Healey" data-kw="Austin Healey" data-lookup="Austin Healey">Austin Healey</option>
												<option value="BMW" data-kw="BMW" data-lookup="BMW">BMW</option>
												<option value="Bentley" data-kw="Bentley" data-lookup="Bentley">Bentley</option>
												<option value="Bugatti" data-kw="Bugatti" data-lookup="Bugatti">Bugatti</option>
												<option value="Buick" data-kw="Buick" data-lookup="Buick">Buick</option>
												<option value="Cadillac" data-kw="Cadillac" data-lookup="Cadillac">Cadillac</option>
												<option value="Chevrolet" data-kw="Chevrolet" data-lookup="Chevrolet">Chevrolet</option>
												<option value="Chrysler" data-kw="Chrysler" data-lookup="Chrysler">Chrysler</option>
												<option value="Citro&euml;n" data-kw="Citro&euml;n" data-lookup="Citro&euml;n">Citro&euml;n</option>
												<option value="Cord" data-kw="Cord" data-lookup="Cord">Cord</option>
												<option value="Daewoo" data-kw="Daewoo" data-lookup="Daewoo">Daewoo</option>
												<option value="Daihatsu" data-kw="Daihatsu" data-lookup="Daihatsu">Daihatsu</option>
												<option value="Datsun" data-kw="Datsun" data-lookup="Datsun">Datsun</option>
												<option value="De Tomaso" data-kw="De Tomaso" data-lookup="De Tomaso">De Tomaso</option>
												<option value="DeLorean" data-kw="DeLorean" data-lookup="DeLorean">DeLorean</option>
												<option value="DeSoto" data-kw="DeSoto" data-lookup="DeSoto">DeSoto</option>
												<option value="Dodge" data-kw="Dodge" data-lookup="Dodge">Dodge</option>
												<option value="Eagle" data-kw="Eagle" data-lookup="Eagle">Eagle</option>
												<option value="Edsel" data-kw="Edsel" data-lookup="Edsel">Edsel</option>
												<option value="Ferrari" data-kw="Ferrari" data-lookup="Ferrari">Ferrari</option>
												<option value="Fiat" data-kw="Fiat" data-lookup="Fiat">Fiat</option>
												<option value="Fisker" data-kw="Fisker" data-lookup="Fisker">Fisker</option>
												<option value="Ford" data-kw="Ford" data-lookup="Ford">Ford</option>
												<option value="GMC" data-kw="GMC" data-lookup="GMC">GMC</option>
												<option value="Geo" data-kw="Geo" data-lookup="Geo">Geo</option>
												<option value="Honda" data-kw="Honda" data-lookup="Honda">Honda</option>
												<option value="Hudson" data-kw="Hudson" data-lookup="Hudson">Hudson</option>
												<option value="Hummer" data-kw="Hummer" data-lookup="Hummer">Hummer</option>
												<option value="Hyundai" data-kw="Hyundai" data-lookup="Hyundai">Hyundai</option>
												<option value="Infiniti" data-kw="Infiniti" data-lookup="Infiniti">Infiniti</option>
												<option value="International Harvester" data-kw="International Harvester" data-lookup="International Harvester">International Harvester</option>
												<option value="Isuzu" data-kw="Isuzu" data-lookup="Isuzu">Isuzu</option>
												<option value="Jaguar" data-kw="Jaguar" data-lookup="Jaguar">Jaguar</option>
												<option value="Jeep" data-kw="Jeep" data-lookup="Jeep">Jeep</option>
												<option value="Kia" data-kw="Kia" data-lookup="Kia">Kia</option>
												<option value="Koenigsegg" data-kw="Koenigsegg" data-lookup="Koenigsegg">Koenigsegg</option>
												<option value="Lamborghini" data-kw="Lamborghini" data-lookup="Lamborghini">Lamborghini</option>
												<option value="Lancia" data-kw="Lancia" data-lookup="Lancia">Lancia</option>
												<option value="Land Rover" data-kw="Land Rover" data-lookup="Land Rover">Land Rover</option>
												<option value="Lexus" data-kw="Lexus" data-lookup="Lexus">Lexus</option>
												<option value="Lincoln" data-kw="Lincoln" data-lookup="Lincoln">Lincoln</option>
												<option value="Lotus" data-kw="Lotus" data-lookup="Lotus">Lotus</option>
												<option value="MG" data-kw="MG" data-lookup="MG">MG</option>
												<option value="Maserati" data-kw="Maserati" data-lookup="Maserati">Maserati</option>
												<option value="Maybach" data-kw="Maybach" data-lookup="Maybach">Maybach</option>
												<option value="Mazda" data-kw="Mazda" data-lookup="Mazda">Mazda</option>
												<option value="McLaren" data-kw="McLaren" data-lookup="McLaren">McLaren</option>
												<option value="Mercedes-Benz" data-kw="Mercedes-Benz" data-lookup="Mercedes-Benz">Mercedes-Benz</option>
												<option value="Mercury" data-kw="Mercury" data-lookup="Mercury">Mercury</option>
												<option value="Mini" data-kw="Mini" data-lookup="Mini">Mini</option>
												<option value="Mitsubishi" data-kw="Mitsubishi" data-lookup="Mitsubishi">Mitsubishi</option>
												<option value="Morgan" data-kw="Morgan" data-lookup="Morgan">Morgan</option>
												<option value="Morris" data-kw="Morris" data-lookup="Morris">Morris</option>
												<option value="Nash" data-kw="Nash" data-lookup="Nash">Nash</option>
												<option value="Nissan" data-kw="Nissan" data-lookup="Nissan">Nissan</option>
												<option value="Oldsmobile" data-kw="Oldsmobile" data-lookup="Oldsmobile">Oldsmobile</option>
												<option value="Opel" data-kw="Opel" data-lookup="Opel">Opel</option>
												<option value="Packard" data-kw="Packard" data-lookup="Packard">Packard</option>
												<option value="Peugeot" data-kw="Peugeot" data-lookup="Peugeot">Peugeot</option>
												<option value="Plymouth" data-kw="Plymouth" data-lookup="Plymouth">Plymouth</option>
												<option value="Pontiac" data-kw="Pontiac" data-lookup="Pontiac">Pontiac</option>
												<option value="Porsche" data-kw="Porsche" data-lookup="Porsche">Porsche</option>
												<option value="Ram" data-kw="Ram" data-lookup="Ram">Ram</option>
												<option value="Renault" data-kw="Renault" data-lookup="Renault">Renault</option>
												<option value="Rolls-Royce" data-kw="Rolls-Royce" data-lookup="Rolls-Royce">Rolls-Royce</option>
												<option value="Saab" data-kw="Saab" data-lookup="Saab">Saab</option>
												<option value="Saturn" data-kw="Saturn" data-lookup="Saturn">Saturn</option>
												<option value="Scion" data-kw="Scion" data-lookup="Scion">Scion</option>
												<option value="Shelby" data-kw="Shelby" data-lookup="Shelby">Shelby</option>
												<option value="Skoda" data-kw="Skoda" data-lookup="Skoda">Skoda</option>
												<option value="Smart" data-kw="Smart" data-lookup="Smart">Smart</option>
												<option value="Studebaker" data-kw="Studebaker" data-lookup="Studebaker">Studebaker</option>
												<option value="Subaru" data-kw="Subaru" data-lookup="Subaru">Subaru</option>
												<option value="Sunbeam" data-kw="Sunbeam" data-lookup="Sunbeam">Sunbeam</option>
												<option value="Suzuki" data-kw="Suzuki" data-lookup="Suzuki">Suzuki</option>
												<option value="Tesla" data-kw="Tesla" data-lookup="Tesla">Tesla</option>
												<option value="Toyota" data-kw="Toyota" data-lookup="Toyota">Toyota</option>
												<option value="Triumph" data-kw="Triumph" data-lookup="Triumph">Triumph</option>
												<option value="Volkswagen" data-kw="Volkswagen" data-lookup="Volkswagen">Volkswagen</option>
												<option value="Volvo" data-kw="Volvo" data-lookup="Volvo">Volvo</option>
												<option value="Willys" data-kw="Willys" data-lookup="Willys">Willys</option>
												<option value="Replica/Kit Makes" data-kw="Replica/Kit Makes" data-lookup="Replica/Kit Makes">Replica/Kit Makes</option>
												<option value="Other Makes" data-kw="Other Makes" data-lookup="Other Makes">Other Makes</option>
											</select>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Couleur</label>
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Mot clé</label>
										<div class="col-md-4 col-sm-4 col-xs-12">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Kilomètre</label>
										<div class="col-md-4 col-sm-4 col-xs-12">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Prix</label>
										<div class="col-md-3 col-sm-3 col-xs-12">
						...
						<div class="x_content">
							...
							<div class="table-responsive">
								@if(!empty($resultJson))
													...
													@if(!in_array(strtolower(trim($car['brand'])), array_map("strtolower", $excludeBrands)))
														@if(! ($cars->where("referenceID", $car['reference_id'])->count() > 0))
															<tr id="{{$car['reference_id']}}-tr">
																...
																<td>GatewayClassicCars</td>
																<!-- <td>
																	@if(isset($car['seller_name']) && !empty($car['seller_name'])) {{$car['seller_name']}} @endif
																	@if(isset($car['specs']) && isset($car['specs']['For Sale By']) && !empty($car['specs']['For Sale By']))
																		{{$car['specs']['For Sale By']}}
																	@endif
																</td> -->
																<td>{{ $car['title'] }}</td>
									...
									@foreach($resultJson as $car)
										@if(!in_array(strtolower(trim($car['brand'])), array_map("strtolower", $excludeBrands)))
											<form id="thisIsViewForm-{{$car['reference_id']}}" action="{{ route('get.gatewayclassiccars.detailsPost') }}" method="POST" target="_blank">
												{{ csrf_field() }}
